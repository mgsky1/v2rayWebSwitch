...
> * Be sure your PHP Engine has authority to execute command in exec() function. In Linux, you should modify `sudoers` use `vi /etc/sudoers` or `visudo`. Note that if you use former method, you may type following commands `$ sudo chmod u+w /etc/sudoers` before continue.
